...
public class LightAxeItem extends FlameModElements.ModElement {
	@ObjectHolder("flame:light_axe")
	public static final Item block = null;
	public LightAxeItem(FlameModElements instance) {
		super(instance, 97);
	}
