...
public class ByeHoeItem extends FlameModElements.ModElement {
	@ObjectHolder("flame:bye_hoe")
	public static final Item block = null;
	public ByeHoeItem(FlameModElements instance) {
		super(instance, 42);
	}
