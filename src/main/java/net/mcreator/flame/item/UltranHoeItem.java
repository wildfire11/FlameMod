...
public class UltranHoeItem extends FlameModElements.ModElement {
	@ObjectHolder("flame:ultran_hoe")
	public static final Item block = null;
	public UltranHoeItem(FlameModElements instance) {
		super(instance, 79);
	}
