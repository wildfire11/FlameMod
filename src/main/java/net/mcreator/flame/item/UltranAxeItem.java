...
public class UltranAxeItem extends FlameModElements.ModElement {
	@ObjectHolder("flame:ultran_axe")
	public static final Item block = null;
	public UltranAxeItem(FlameModElements instance) {
		super(instance, 76);
	}
