...
public class ByeShovelItem extends FlameModElements.ModElement {
	@ObjectHolder("flame:bye_shovel")
	public static final Item block = null;
	public ByeShovelItem(FlameModElements instance) {
		super(instance, 41);
	}
