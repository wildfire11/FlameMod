...
public class WoodsFenceBlock extends FlameModElements.ModElement {
	@ObjectHolder("flame:woods_fence")
	public static final Block block = null;
	public WoodsFenceBlock(FlameModElements instance) {
		super(instance, 133);
	}
