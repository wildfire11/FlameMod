...
public class UltranBlockBlock extends FlameModElements.ModElement {
	@ObjectHolder("flame:ultran_block")
	public static final Block block = null;
	public UltranBlockBlock(FlameModElements instance) {
		super(instance, 71);
	}
