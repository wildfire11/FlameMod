...
public class WoodsButtonBlock extends FlameModElements.ModElement {
	@ObjectHolder("flame:woods_button")
	public static final Block block = null;
	public WoodsButtonBlock(FlameModElements instance) {
		super(instance, 136);
	}
