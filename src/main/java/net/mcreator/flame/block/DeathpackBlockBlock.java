...
public class DeathpackBlockBlock extends FlameModElements.ModElement {
	@ObjectHolder("flame:deathpack_block")
	public static final Block block = null;
	public DeathpackBlockBlock(FlameModElements instance) {
		super(instance, 50);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("deathpack_block");
		}
