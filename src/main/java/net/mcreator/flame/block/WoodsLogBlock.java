...
public class WoodsLogBlock extends FlameModElements.ModElement {
	@ObjectHolder("flame:woods_log")
	public static final Block block = null;
	public WoodsLogBlock(FlameModElements instance) {
		super(instance, 128);
	}
