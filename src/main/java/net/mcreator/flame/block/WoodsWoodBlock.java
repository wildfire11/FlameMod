...
public class WoodsWoodBlock extends FlameModElements.ModElement {
	@ObjectHolder("flame:woods_wood")
	public static final Block block = null;
	public WoodsWoodBlock(FlameModElements instance) {
		super(instance, 127);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(18f, 11.599092269590578f).setLightLevel(s -> 0)
					.harvestLevel(0).harvestTool(ToolType.AXE).setRequiresTool());
			this.setDefaultState(this.stateContainer.getBaseState().with(AXIS, Direction.Axis.Y));
			setRegistryName("woods_wood");
		}
