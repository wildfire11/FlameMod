...
public class WoodsSlabBlock extends FlameModElements.ModElement {
	@ObjectHolder("flame:woods_slab")
	public static final Block block = null;
	public WoodsSlabBlock(FlameModElements instance) {
		super(instance, 132);
	}
