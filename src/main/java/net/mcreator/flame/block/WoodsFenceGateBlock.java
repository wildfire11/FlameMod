...
public class WoodsFenceGateBlock extends FlameModElements.ModElement {
	@ObjectHolder("flame:woods_fence_gate")
	public static final Block block = null;
	public WoodsFenceGateBlock(FlameModElements instance) {
		super(instance, 134);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("woods_fence_gate");
		}
