...
public class DeadBiome extends FlameModElements.ModElement {
	public static Biome biome;
	public DeadBiome(FlameModElements instance) {
		super(instance, 4);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(Blocks.GILDED_BLACKSTONE.getDefaultState(),
								DeathblockBlock.block.getDefaultState(), DeathblockBlock.block.getDefaultState())));
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.TREE
						.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(Blocks.CRYING_OBSIDIAN.getDefaultState()),
								new SimpleBlockStateProvider(Blocks.CRIMSON_STEM.getDefaultState()),
								new BlobFoliagePlacer(FeatureSpread.func_242252_a(2), FeatureSpread.func_242252_a(0), 3),
								new StraightTrunkPlacer(11, 2, 0), new TwoLayerFeature(1, 0, 1)))
				...
				event.getRegistry().register(biome.setRegistryName("flame:dead"));
			}
		}
	}
	@Override
	public void init(FMLCommonSetupEvent event) {
		BiomeManager.addBiome(BiomeManager.BiomeType.WARM,
				new BiomeManager.BiomeEntry(RegistryKey.getOrCreateKey(Registry.BIOME_KEY, WorldGenRegistries.BIOME.getKey(biome)), 61));
	}
